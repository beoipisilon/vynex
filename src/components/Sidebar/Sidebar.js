...
const Sidebar = () => {
    ...
    return (
        <div className="sidebar-main flex col gap-1">
            <Link to={"/"} className={`sidebar-nav flex gap-1 ${location.pathname === "/" ? "active" : ""}`} title="Home">
            ...
            <Link to={"/music"} className={`sidebar-nav flex gap-1 ${location.pathname === "/music" ? "active" : ""}`} title="Music">
                <div className="nav-icon">
